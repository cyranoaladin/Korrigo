...
Password:  eleve2025
Email:     eleve1@viatique.local, etc.
```
...
student_user = User.objects.create_user(
    username='eleve_new',
    email='eleve.new@viatique.local',
...
# Students
students_data = [
    {'username': 'eleve1', 'email': 'eleve1@viatique.local', 'first_name': 'Jean', 'last_name': 'Dupont', 'dob': date(2008, 5, 15)},
    {'username': 'eleve2', 'email': 'eleve2@viatique.local', 'first_name': 'Marie', 'last_name': 'Martin', 'dob': date(2007, 12, 3)},
]
