...
|-----|-------------|--------|----------|
| PRD-01 | Baseline (git clean, tag) | ✅ PASS | `docs/proofs/prd/2026-02-02_1030/PRD-01/` |
| PRD-02 | Docker compose prod config | ✅ PASS | `docs/proofs/prd/2026-02-02_1030/PRD-02/` |
| PRD-03 | Docker compose local-prod config | ✅ PASS | `docs/proofs/prd/2026-02-02_1030/PRD-03/` |
| PRD-04 | Build images (no-cache) | ✅ PASS | `docs/proofs/prd/2026-02-02_1030/PRD-04/` |
| PRD-05 | Boot stack + services UP | ✅ PASS | `docs/proofs/prd/2026-02-02_1030/PRD-05/` |
| PRD-06 | Migrations applied | ✅ PASS | `docs/proofs/prd/2026-02-02_1030/PRD-06/` |
| PRD-07 | Collectstatic + nginx config | ✅ PASS | `docs/proofs/prd/2026-02-02_1030/PRD-07/` |
| PRD-08 | Seed deterministic + idempotent | ✅ PASS | `docs/proofs/prd/2026-02-02_1030/PRD-08/` |
| PRD-09 | Backend tests (384 passed) | ✅ PASS | `docs/proofs/prd/2026-02-02_1030/PRD-09/` |
| PRD-10 | Frontend build prod | ✅ PASS | `docs/proofs/prd/2026-02-02_1030/PRD-10/` |
| PRD-11 | Frontend lint | ✅ PASS | `docs/proofs/prd/2026-02-02_1030/PRD-11/` |
| PRD-12 | E2E tests (23 passed) | ✅ PASS | `docs/proofs/prd/2026-02-02_1030/PRD-12/` |
| PRD-13 | Auth/Lockout TTL | ✅ PASS | `docs/proofs/prd/2026-02-02_1030/PRD-13/` |
| PRD-14 | Workflow métier complet | ✅ PASS | `docs/proofs/prd/2026-02-02_1030/PRD-14/` |
| PRD-15 | Restart resilience | ✅ PASS | `docs/proofs/prd/2026-02-02_1030/PRD-15/` |
| PRD-16 | Security headers/nginx | ✅ PASS | `docs/proofs/prd/2026-02-02_1030/PRD-16/` |
| PRD-17 | Observabilité + no PII | ✅ PASS | `docs/proofs/prd/2026-02-02_1030/PRD-17/` |
| PRD-18 | Runbook finalisé | ✅ PASS | `PROD_RUNBOOK.md` |
| PRD-19 | Gate final (rebuild from scratch) | ✅ PASS | `docs/proofs/prd/2026-02-02_1030/PRD-19/` |
