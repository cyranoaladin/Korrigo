# Decision migrations `exams` 0039-0042
...
| `0042_copy_pdf_regeneration_pending_db_default.py` | presente, SHA-256 `1679f9f09c0f31773c8901b981e2816564211830cf6a948b4008b42ae8be2a8c` | absente | absente | non appliquee |
...
- Ajouter pendant l'Etape 2 une migration de reconciliation apres `0042` si necessaire pour aligner explicitement l'etat Django final avec le schema live a 3 statuts. Cette migration devra:
