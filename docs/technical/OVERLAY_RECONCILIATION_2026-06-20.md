...
|---|---|---|---|
| `backend/exams/views.py` | `overlay/exams/views.py` actif | Overlay actif integre; ajout local `grading_structure` conserve car strictement additionnel pour le portail eleve. | `27349bc45ec80a6cf2d861e63eaba0ccdca172c426e86f15cbc395cffd4ccac1` |
...
| `backend/core/views.py` | `overlay/core/views.py` actif | Parite exacte avec overlay actif, rien a copier. | `57886fe21122f54d1e05bdd0434db08031da02ce631abb40a9e17e406e823494` |
...
| `backend/bilan/permissions.py` | `overlay/backend/bilan/permissions.py` actif | Overlay actif integre tel quel pour conserver le fallback local `DIRECTION_GROUPS`. | `8ca7b5708e9c6598ef76bcae86e7dbab0175d1bb07b2298da81e8d9f62e3ba11` |
