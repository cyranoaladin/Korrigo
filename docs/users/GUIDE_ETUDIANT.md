...
```mermaid
graph LR
    A[1. Vous passez l'examen sur papier] --> B[2. Les copies sont scannées]
    B --> C[3. Vos professeurs corrigent sur ordinateur]
    C --> D[4. Vous consultez votre copie corrigée en ligne]
