...
run_logged "13_pytest_full" docker compose --env-file "$COMPOSE_ENV_FILE" -f "$COMPOSE_FILE" exec -T -e DJANGO_SETTINGS_MODULE=core.settings_test "$BACKEND_SVC" python -m pytest -v --tb=short -m ""
