# .claude/ - Système de Gouvernance Technique du Projet Viatique
...
- **Prioritaire** : En cas de conflit avec d'autres documentations, .claude/ prévaut
...
Le `.claude/` suit le versioning sémantique : `MAJOR.MINOR.PATCH`
...
#### v1.1.0 (2026-01-21)
- ✅ Ajout dossier `decisions/` avec 3 ADR exemples
- ✅ Section tests minimaux obligatoires (00_global_rules.md)
- ✅ Section audit trail et traçabilité (01_security_rules.md)
- ✅ Versioning explicite du système de gouvernance

#### v1.0.0 (2026-01-21)
- ✅ Création initiale du système de gouvernance
- ✅ 7 fichiers rules (00 à 06)
- ✅ 5 fichiers skills
- ✅ 6 fichiers workflows
- ✅ 3 fichiers checklists

### Procédure de Mise à Jour

Toute modification du `.claude/` doit :
...
5. Commit explicite : `git commit -m "chore(.claude): bump to v1.x.y - raison"`
