    ...
    <main class="max-w-7xl mx-auto px-6 py-8 space-y-8">
      ...
      >
        <div
          ...
          class="space-y-3"
        >
          <div class="h-4 bg-slate-200 rounded w-40 animate-pulse" />
          <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            >
              ...
              <div class="h-3 bg-slate-100 rounded w-1/2 mb-2" />
      ...
      >
        ...
        <p class="text-slate-400 text-sm mt-1 mb-6">
          Commencez par créer ou importer un examen.
        </p>
        <button
                ...
                <div class="flex items-center gap-1.5 text-xs text-slate-500">
                  ...
                  >
                    <path
                      stroke-linecap="round"
                      stroke-linejoin="round"
                      d="M9 12h6m-6 4h6M7 2h10a2 2 0 012 2v16a2 2 0 01-2 2H7a2 2 0 01-2-2V4a2 2 0 012-2z"
                    />
                  </svg>
