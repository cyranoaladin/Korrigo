  ...
  >
    ...
    <main class="max-w-7xl mx-auto px-6 py-8 space-y-8">
      ...
      >
        ...
        {{ error }}
        <button
          class="ml-auto text-red-500 hover:text-red-700 font-medium"
          @click="fetchExams"
        >
          Réessayer
        </button>
      ...
      <section>
        ...
        <div
          v-if="loading"
          class="grid grid-cols-2 gap-4 sm:grid-cols-4 xl:grid-cols-7"
        >
          <div
            v-for="i in 7"
            :key="i"
          ...
          >
            <div class="h-3 bg-slate-200 rounded w-2/3 mb-3" />
            <div class="h-7 bg-slate-200 rounded w-1/2" />
          </div>
        </div>
      ...
      <section>
        ...
        >
          <div
            v-for="i in 4"
            :key="i"
            class="flex items-center gap-4 px-6 py-4 border-b border-slate-100 last:border-0 animate-pulse"
          >
            <div class="h-4 bg-slate-200 rounded w-1/4" />
            <div class="h-4 bg-slate-200 rounded w-1/6" />
            <div class="h-4 bg-slate-200 rounded w-1/6" />
            <div class="h-4 bg-slate-200 rounded w-1/5 ml-auto" />
          </div>
        </div>
        ...
        >
          ...
          <p class="text-slate-400 text-sm mt-1">
            Les examens créés apparaîtront ici.
          </p>
        </div>
            ...
            <table class="w-full text-sm">
              <thead>
                <tr class="border-b border-slate-200 bg-slate-50">
                  ...
                  <th class="px-6 py-3 text-left text-xs font-semibold text-slate-500 uppercase tracking-wider w-48">
                    Progression
                  </th>
                  <th class="px-6 py-3 text-left text-xs font-semibold text-slate-500 uppercase tracking-wider">
                    Statut
              ...
              <tbody class="divide-y divide-slate-100">
                ...
                >
                  ...
                  <td class="px-6 py-4 text-slate-600 whitespace-nowrap">
                    ...
                    <span
                      v-if="getExamCounts(exam).inProgress > 0"
                      class="text-amber-500 text-xs ml-1"
                    >(+{{ getExamCounts(exam).inProgress }} en cours)</span>
